...
## Pipeline rules — where they live

The pipeline phase rules (Phase 2, 3, 4, 5, Gate G3) are defined
in the CLAUDE.md template inside src/generator.js.

When working on this CLI you are building the tool —
not running the pipeline the tool generates.

To see or edit the pipeline rules:
  src/generator.js → search for "## Phase 2"
